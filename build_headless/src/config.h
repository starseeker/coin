...
#ifdef _DEBUG
#define COIN_SYSTEM_LIBRARY_NAME "libCoin.so.80.0.7"
#else
#define COIN_SYSTEM_LIBRARY_NAME "libCoin.so.80.0.7"
#endif
...
#define OPENGL_SYSTEM_LIBRARY_NAME ".so"
...
#define PACKAGE_STRING "Coin 4.0.7"
...
#define COIN_DATADIR    "share/Coin"

/* Enable thread check in several central Coin functions. */
/* #undef COIN_DEBUG_CHECK_THREAD */
